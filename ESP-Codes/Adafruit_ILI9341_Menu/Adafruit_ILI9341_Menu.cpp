...
// Added by Adab Bawa
int EditMenu::addMI(const char *ItemLabel, const uint16_t *Bitmap, uint8_t BitmapWidth, uint8_t BitmapHeight) {
...
// Added by Adab Bawa
void ItemMenu::setItemText(int ID, const char *ItemText) {
  stringValues[ID] = ItemText;
}
